...
TEST_F(TaskSetForTest_scheduling_v1, RT_v1) {
    ...
    EXPECT_EQ(16, ObjReactionTime::Obj(dag_tasks, tasks_info, schedule,
                                       dag_tasks.chains_));
    EXPECT_EQ(
        6, ObjDataAge::Obj(dag_tasks, tasks_info, schedule, dag_tasks.chains_));
}
TEST_F(TaskSetForTest_scheduling_v1, RT_v2) {
    ...
    EXPECT_EQ(43 - 5, ObjReactionTime::Obj(dag_tasks, tasks_info, schedule,
                                           dag_tasks.chains_));
    EXPECT_EQ(43 - 10, ObjDataAge::Obj(dag_tasks, tasks_info, schedule,
                                       dag_tasks.chains_));
}

TEST_F(TaskSetForTest_scheduling_v1, RT_v3) {
    ...
    EXPECT_EQ(25, ObjReactionTime::Obj(dag_tasks, tasks_info, schedule,
                                       dag_tasks.chains_));
    EXPECT_EQ(25 - 10, ObjDataAge::Obj(dag_tasks, tasks_info, schedule,
                                       dag_tasks.chains_));
}
